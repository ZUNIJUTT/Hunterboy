...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Hunter Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY HUNTER BOY \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          Aby ya script fack ha'
    print '         Copy mat karna salo'
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
    print ' [1] START'
    print ' [2] FOLLOW HUNTER ON FB '
    print ' [3] CONTACT WITH OWNER 'MA NAHI BTAO GA
    print ''
    menu_option()
